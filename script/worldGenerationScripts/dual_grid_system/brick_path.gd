...
@export var PATHPlaceholderAtlasCoord : Vector2i
...
var neighboursToAtlasCoord : Dictionary = {
	# All corners
	[TileType.PATH, TileType.PATH, TileType.PATH, TileType.PATH] : Vector2i(2, 1),
	# Outer bottom-right corner
	[TileType.NONE, TileType.NONE, TileType.NONE, TileType.PATH] : Vector2i(1, 3),
	# Outer bottom-left corner
	[TileType.NONE, TileType.NONE, TileType.PATH, TileType.NONE] : Vector2i(0, 0),
	# Outer top-right corner
	[TileType.NONE, TileType.PATH, TileType.NONE, TileType.NONE] : Vector2i(0, 2),
	# Outer top-left corner
	[TileType.PATH, TileType.NONE, TileType.NONE, TileType.NONE] : Vector2i(3, 3),
	# Right edge
	[TileType.NONE, TileType.PATH, TileType.NONE, TileType.PATH] : Vector2i(1, 0),
	# Left edge
	[TileType.PATH, TileType.NONE, TileType.PATH, TileType.NONE] : Vector2i(3, 2),
	# Bottom edge
	[TileType.NONE, TileType.NONE, TileType.PATH, TileType.PATH] : Vector2i(3, 0),
	# Top edge
	[TileType.PATH, TileType.PATH, TileType.NONE, TileType.NONE] : Vector2i(1, 2),
	# Inner bottom-right corner
	[TileType.NONE, TileType.PATH, TileType.PATH, TileType.PATH] : Vector2i(1, 1),
	# Inner bottom-left corner
	[TileType.PATH, TileType.NONE, TileType.PATH, TileType.PATH] : Vector2i(2, 0),
	# Inner top-right corner
	[TileType.PATH, TileType.PATH, TileType.NONE, TileType.PATH] : Vector2i(2, 2),
	# Inner top-left corner
	[TileType.PATH, TileType.PATH, TileType.PATH, TileType.NONE] : Vector2i(3, 1),
	# Bottom-left top-right corners
	[TileType.NONE, TileType.PATH, TileType.PATH, TileType.NONE] : Vector2i(2, 3),
	# Top-left down-right corners
	[TileType.PATH, TileType.NONE, TileType.NONE, TileType.PATH] : Vector2i(0, 1),
	# No corners
...
func get_world_tile(coords : Vector2i) -> TileType:
	...
	if atlas_coord == PATHPlaceholderAtlasCoord:
